...
// // TODO: fix this
// pub async fn run(_options: &[CommandDataOption], cln_client:
// &Arc<Mutex<ClnRpc>>) -> String {     let req =
// cln_rpc::model::requests::GetinfoRequest {};     let res: GetinfoResponse =
// match cln_client.lock().await.call(Getinfo(req)).await.unwrap() {
...
// pub fn register(command: &mut CreateApplicationCommand) -> &mut
